...
import { 
  ...
  ROTATION_ANGLE,
  MIDDLE_LAYER_INDEXES,
  EQUATOR_LAYER_INDEXES
...
const MOVES = [
  ...
  { indices: SLICE_LAYER_INDEXES, axis: Z_CLOCKWISE_ROTATION, name: "S" },
  { indices: SLICE_LAYER_INDEXES, axis: Z_COUNTERCLOCKWISE_ROTATION, name: "S'" },
  { indices: MIDDLE_LAYER_INDEXES, axis: X_COUNTERCLOCKWISE_ROTATION, name: "M" },
  { indices: MIDDLE_LAYER_INDEXES, axis: X_CLOCKWISE_ROTATION, name: "M'" },
  { indices: EQUATOR_LAYER_INDEXES, axis: Y_COUNTERCLOCKWISE_ROTATION, name: "E" },
  { indices: EQUATOR_LAYER_INDEXES, axis: Y_CLOCKWISE_ROTATION, name: "E'" },
